...
import { auth, signInWithGoogle, signInWithGuestSync, logOut, onAuthChange, listenToCloudData, syncLocalToCloud } from '../firebase';
...
export const CloudSyncBanner: React.FC<CloudSyncBannerProps> = ({ onSyncComplete, compact }) => {
  ...
  const handleGuestSignIn = async () => {
    ...
    try {
      ...
      console.error('Instant guest sync error:', err);
