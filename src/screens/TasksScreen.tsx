...
import { CheckCircle2, Circle, Pin, Plus, Trash2, Filter, Tag } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900 border border-slate-800 rounded-2xl p-5 shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Organize and prioritize your daily action items</p>
          </div>
        </div>
